...
public class SerializationDemo {
    public static void main(String[] args) {
        ...
        //make deserialization of object
        try (ObjectInputStream objStrm = new ObjectInputStream(new FileInputStream("serial"))) {
            MyClass object2 = (MyClass) objStrm.readObject();
